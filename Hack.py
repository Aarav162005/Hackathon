...
@app.route('/')
def home():
    return render_template('index.html', hospitals=hospitals, doctors=doctors, treatments=treatments)
...
def search():
    ...
    return render_template('index.html', hospitals=search_results['hospitals'], doctors=search_results['doctors'], treatments=search_results['treatments'])
